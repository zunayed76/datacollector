    ...
    public function run(): void
    {
        ...
        foreach ($divisionsData as $divName => $districts) {
            ...
            foreach ($districts as $distName) {
                ...
                // For Thanas, if you want exactly 3 per district without duplicates:
